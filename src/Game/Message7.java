        ...
        jt1.addActionListener(new ActionListener() { // 监听器
            public void actionPerformed(ActionEvent e) {
                ...
                if (s.equals("1")||s.equals("2")) {
                    ...
                    jt2.setText("你不会什么都不知道吧？海尔辛！万干神灵的创造者与守护者知道吗？海尔辛的呼唤......好吧，它会揭露事物的本质，展现出他们心中野蛮残忍的真实一面。\n1.你好像真的很了解狼人。");
                }else if (s.equals("111")||s.equals("211")) {
                    jt2.setText("好吧，好吧，这是黑暗真相，我和法奥楚有关，他是我的祖先，每一天，我和我的家族都生活在他的阴影之下，现在他回来了，所以我猎杀狼人一我要杀光他们，你准备好后就去山洞找我吧。\n1.再见");
