    ...
    public Message9() {
        ...
        jt1.addActionListener(new ActionListener() { // 监听器
            public void actionPerformed(ActionEvent e) {
                ...
                if (s.equals("1")) {
                    jt2.setText("法奥楚一直在阻挡我的路，这个失败落在了我的脑海里，\n但我们现在可以解决这个问題了，我得死，你需要拿走我的血。1.什么？");
                } else if (s.equals("11")) {
                    jt2.setText(
                            "我们在浪费时间！我需要死，这样你就能拿走我的血。\n如果时间持续，主人的血就能治愈他的生物，\n你知道我是法奥楚的后代，如果公爵喝了我的血，他就会治愈诅咒。\n1.凯姆洛恩需要要公爵，对不起格洛丽亚，但你得死。\n2.不，不是这样的，我们需要你活着，我会处理公爵的。");
                } else if (s.equals("111") || s.equals("1121")) {
                    jf.dispose();
                } else if (s.equals("112")) {
                    jt2.setText("希望你的态度不会让其他人遭到不幸。不过我想我还是会活下来的\n趁还来得及，赶紧走吧，我会在公爵家和你碰头。\n1.再见。");
                }
            }
