    ...
    public Message3() {
        ...
        jt1.addActionListener(new ActionListener() { // 监听器
            public void actionPerformed(ActionEvent e) {
                ...
                if (s.equals("1")) {
                    jt2.setText(
                            "我正好用得上你这样身经百战的战士，那些当地的守卫真是指望不上！公爵现在被血荆棘看押在灯塔顶，\n我本来想等援军到了再做打算的。你胆子不小，\n很好，增援到来之后，我们一定要把邪教徒一网打尽，一个都不能溜走。\n如果你的计划失败了，那我们只好事后去酒馆缅怀你的过往了。\n 1.雄狮卫为什么在这儿？");
                } else if (s.equals("11")) {
                    jt2.setText("我们被派来此处是为了向公爵提供更多保护，阻止这样的事情发生。\n我们没能早点赶到实在是太糟了。本地守卫没有做好对付血荆棘的准备。\n1.再见。");
